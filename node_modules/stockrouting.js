...
router.get("/stock/list.html",rle.isAdmin, function (req, resp) {
...
router.get("/stock/managment.html", rle.isAdmin,function (req, resp) {
...
router.post("/stock/modif/:id",rle.isAdmin, function (req, resp) {
