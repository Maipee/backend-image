...
router.get("/stockorder/list.html",rle.isAdmin,function (req, resp) {
...
router.get("/stockt/management.html",rle.isAdmin, function (req, resp) {
...
router.post("/stock/moidif/:id",rle.isAdmin, function (req, resp) {
...
///////////////////////route "admin/stock/moidif/:id" ////////////////////////////////////////////////admin/stock/moidif/5
router.get("/stock/transfer/:id/:qt",rle.isAdmin, function (req, resp) {
    var id = req.params.id;
