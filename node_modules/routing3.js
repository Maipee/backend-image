			...
			mysqlhelper.pool.query('SELECT * FROM products ORDER BY id DESC LIMIT 5',function(err,rows){
				...
				else
				{
					...
					if(typeof req.user !== 'undefined')
					{
						...
						resp.render("index.html.twig",{"username":req.user.username,"nbitem":nbitem,"role":req.user.role,"newarrivals":newarrivals,"banners":banners,"list_new_arrivals":sales,"total":tot});
					}
					else
					{
						if(req.session.caddy){
						...
						var tot= total(req);
						console.log('total :'+tot)
						resp.render("index.html.twig",{"nbitem":nbitem,"newarrivals":newarrivals,"banners":banners,"list_new_arrivals":sales,"total":tot});
					}										
				}				
			});							
		}				
