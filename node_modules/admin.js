...
/////////////////////////////////////////////////////////////////////////////////
////Route ADMINISTRATION DES MESSAGES ENVOYEES PAR LE FORMULAIRE DE CONTACT/////
////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////
//////////////////Route de preparation pour modification ulterieur du produit////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////
//////////////////Route pour modification produit en bdd ////////////////////////
////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////
//////////////////Tout l'Historique des commandes clients ////////////////////////
////////////////////////////////////////////////////////////////////////////////
        ...
        if (err != null) {
            ...
            //console.log('Tous les produits: '+JSON.stringify(rows));
             ...
             //si le user enregistré en session est different de nul
                if (typeof req.user !== 'undefined') {
                    //alors je renvoie le twig avec un tablo qui recupere les elements de username
                    resp.render("admin/client.html.twig", { "username": req.user.username,"clients":rows});
                }
                //sinon je renvoie le user a la page login pour authentification
                else {
                    resp.redirect("/login.html");
...
/////////////////////////////////////////////////////////////////////////////////
//////////////////Historique des commandes clients avec filtre date ////////////////////////
////////////////////////////////////////////////////////////////////////////////
        ...
        if (err != null) {
            ...
            //console.log('Tous les produits: '+JSON.stringify(rows));
             ...
             //si le user enregistré en session est different de nul
                if (typeof req.user !== 'undefined') {
                    //alors je renvoie le twig avec un tablo qui recupere les elements de username
                    resp.render("admin/client.html.twig", { "username": req.user.username,"clients":rows,"date1":dateFiltre,"date2":dateFiltre2 });
                }
                //sinon je renvoie le user a la page login pour authentification
                else {
                    resp.redirect("/login.html");
...
/////////////////////////////////////////////////////////////////////////////////
//////////////////Historique des commandes des fournisseur ////////////////////////
////////////////////////////////////////////////////////////////////////////////
        ...
        if (err != null) {
            ...
            //console.log('Tous les produits: '+JSON.stringify(rows));
             ...
             //si le user enregistré en session est different de nul 
                if (typeof req.user !== 'undefined') {
                    //alors je renvoie le twig avec un tablo qui recupere les elements de username
                    resp.render("admin/fournisseur.html.twig", { "username": req.user.username,"fournisseurs":rows});
                }
                //sinon je renvoie le user a la page login pour authentification
                else {
                    resp.redirect("/login.html");
...
/////////////////////////////////////////////////////////////////////////////////
//////////////////Historique des commandes fournisseur avec filtre date ////////////////////////
////////////////////////////////////////////////////////////////////////////////
        ...
        if (err != null) {
            ...
            //console.log('Tous les produits: '+JSON.stringify(rows));
             ...
             //si le user enregistré en session est different de nul 
                if (typeof req.user !== 'undefined') {
                    //alors je renvoie le twig avec un tablo qui recupere les elements de username
                    resp.render("admin/fournisseur.html.twig", { "username": req.user.username,"fournisseurs":rows,"date1":dateFiltre,"date2":dateFiltre2 });
                }
                //sinon je renvoie le user a la page login pour authentification
                else {
                    resp.redirect("/login.html");
        ...
        if (err != null) {
            ...
            //console.log('Tous les produits: '+JSON.stringify(rows));
             ...
             //si le user enregistré en session est different de nul
                if (typeof req.user !== 'undefined') {
                    //alors je renvoie le twig avec un tablo qui recupere les elements de username
                    resp.render("admin/fournisseurs.html.twig", { "username": req.user.username,"fournisseurs":rows});
                }
                //sinon je renvoie le user a la page login pour authentification
                else {
                    resp.redirect("/login.html");
...
/////////////////////////////////////////////////////////////////////////////////
//////////////////Affiche fournisseur avec infos complementaire  ////////////////
////////////////////////////////////////////////////////////////////////////////
        ...
        if (err != null) {
            ...
            //console.log('Tous les produits: '+JSON.stringify(rows));
             ...
             //si le user enregistré en session est different de nul (typeof verifi le type de donné)
                if (typeof req.user !== 'undefined') {
                    //alors je renvoie le twig avec un tablo qui recupere les elements de username
                    resp.render("admin/fournid.html.twig", { "username": req.user.username,"fournisseurs":rows});
                }
                //sinon je renvoie le user a la page login pour authentification
                else {
                    resp.redirect("/login.html");
...
/////////////////////////////////////////////////////////////////////////////////
//////////////////Affiche Toutes les commandes clients en cours de livraison  //
////////////////////////////////////////////////////////////////////////////////

///////////////////////route "/encoursclient.html"////////////////////////////////////////////////
        ...
        if (err != null) {
            ...
            //console.log('Tous les produits: '+JSON.stringify(rows));
             ...
             //si le user enregistré en session est different de nul
                if (typeof req.user !== 'undefined') {
                    //alors je renvoie le twig avec un tablo qui recupere les elements de username
                    resp.render("admin/encoursclient.html.twig", { "username": req.user.username,"clients":rows});
                }
                //sinon je renvoie le user a la page login pour authentification
                else {
                    resp.redirect("/login.html");
...
/////////////////////////////////////////////////////////////////////////////////
/////changement de status pour la commande clients(id) en cours de livraison//
////////////////////////////////////////////////////////////////////////////////
            ...
            sqlhelper.pool.query("SELECT * FROM `products` WHERE `id` = ?",[idp], function (err, rows, fields) {
                ...
                if (qtm<20) {
                        ...
                        //sinon
                            ...
                            console.log("Nous avons mis le systeme à jours basculant 20 unités (en base de données) du produit "+idp+"de l'entrepot vers le magasins, vueillez suivre la procedure physiquement, merci");
                        //--------------------------------------------------------------------------------------------
                        //--------------------------------------------------------------------------------------------
                            //on enleve 20 quantie de l'entrepot et on les bascules dans le magasin
                            messageService ="Nous avons mis le systeme à jours basculant 20 unités (en base de données) du produit "+idp+"de l'entrepot vers le magasins, vueillez suivre la procedure physiquement, merci";
                            var qtm2=qtm+20;
                            var qte2=qte-20;
...
/////////////////////////////////////////////////////////////////////////////////
///// -- Toutes les commandes en cours des fournisseurs --//
////////////////////////////////////////////////////////////////////////////////

///////////////////////route "/encoursfourniseur.html"////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////
/////  -- Pour changer le statu des commandes en cours des fournisseurs  --//
////////////////////////////////////////////////////////////////////////////////

///////////////////////route "/encoursfourniseur/:idp&:qtp&:ste&:ido"////////////////////////////////////////////////
router.get("/encoursfourniseur/:idp&:qtp&:ste&:ido&:ref&:prix", function (req, resp) {
    var idp = req.params.idp;
    ...
    //on change la qunatité dans product du stock de l'entrepot
     sqlhelper.pool.query("UPDATE `products` SET `stockEntrepot` = ? WHERE `products`.`id` = ?;",[newq,idp], function (err, rows, fields) {
        ...
        if (err != null) {
            ...
            //on change le status de la commande (ido) encours2livr à 1 pour signifier qu'il a été livré
            ...
            //on change le status de la commande (ido2) encours2livr à 1 pour signifier qu'il a été livré
            sqlhelper.pool.query("UPDATE `orders` SET `encours2livr` = 1 WHERE `orders`.`id` =  ?;",[ido2], function (err, rows, fields) {
             ...
             //si le user enregistré en session est different de nul (typeof verifi le type de donné)
                if (typeof req.user !== 'undefined') {
                    messageService ="Nous avons mis le systeme à jours basculant "+qto+" unité(s) (en base de données) du produit "+idp+" pour les stocks magasins, merci";
                    //alors je renvoie le twig avec un tablo qui recupere les elements de username
                    resp.status(200).end("Le nouveau statu 'livré' a bien été pris en compte");
                }
                //sinon je renvoie le user a la page login pour authentification
                else {
                    resp.redirect("/login.html");
