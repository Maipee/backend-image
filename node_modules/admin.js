...
//Route de la page formProduct modify GET

router.get("admin/product.html/:id",function(req,resp){
	if(typeof req.user !== 'undefined')
	{
		console.log('connection mysql profil form');
		mysqlhelper.pool.query('SELECT * FROM product WHERE product.id = ? ',[product.id],function(err,rows,fields){	
	});
	}
	else{
		resp.render("admin/product.html.twig",{});
	}
});
	

//Route de la page formProduct modify POST

router.post("admin/product.html",function(req,resp){
	
});



//Route de la page formProduct delete

router.get("admin/deleteProduct/:idtype",function(req,resp){
	var adressetype = req.params.adresstype;
	if(typeof req.user !== 'undefined')
	{
		mysqlhelper.pool.query('DELETE FROM product WHERE idtype = ?',[idtype],function(err,rows,fields){
			console.log('query delete: '+idtype);
		});
		resp.render("admin/dashboardProducts.html.twig", { "list_products": rows });
	}
	else
...
//Route de la page formProduct new

//Route de la page formProduct disactive product
